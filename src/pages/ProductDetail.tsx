        ...
        <div id="pricing-tables" className="padding-top padding-bottom">
            <div className="container-fluid d-flex justify-content-center mt-4">
                <div className="col-12 col-md-8 col-lg-6">
                    <div className="single-table d-flex flex-column justify-content-between w-100 m-4 p-4 rounded shadow-lg" style={{ backgroundColor: "#fff" }}>
                        ...
                        <button
                            ...
                            className="btn btn-primary mt-2 border-white rounded text-light"
                        >
                            Add To Basket
                        </button>
                    </div>
